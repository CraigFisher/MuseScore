...
void Ambitus::layout()
      ...
      if (_topPitch == INVALID_PITCH || _topTpc == Tpc::TPC_INVALID)
            ...
            topLine  = absStep(_topTpc, _topPitch, altNoteMappings()); //cc
            topLine  = relStep(topLine, clf, altNoteMappings()); //cc
      ...
      if (_bottomPitch == INVALID_PITCH || _bottomTpc == Tpc::TPC_INVALID)
            ...
            bottomLine  = absStep(_bottomTpc, _bottomPitch, altNoteMappings()); //cc
            bottomLine  = relStep(bottomLine, clf, altNoteMappings()); //cc
